...
### 1. Deep Learning for Solving and Estimating Dynamic Stochastic Models (days 1 & 2)
...
* [Apply to the summer school (and conference)](https://docs.google.com/forms/d/e/1FAIpQLSeIMOm-iSFV-m2ZBfjvLb4Bsh33YkfmwnJJnbp8uynv1EFWRw/viewform) — inside this form you can choose to apply for the summer school only, or for both the summer school and the conference.
* [Apply to the conference only](https://docs.google.com/forms/d/e/1FAIpQLSdhnkbRc6zCM9pu6so6tcCbJv3nvgU5kmQkxCIux0PcKFV5jQ/viewform).
* For application deadlines and any updates, please consult the [summer school website](https://sites.google.com/carloalberto.org/deeplearningsummerschool2026).


## Fees

| Participant | Summer school + conference | Summer school | Conference |
|------|------|------|------|
| Ph.D. students | 450 CHF | 300 CHF | 150 CHF |
| Researchers and professors | 700 CHF | 450 CHF | 250 CHF |
| Online participants | — | 100 CHF | — |

Online participation is limited to streaming only, and chat responses will not be available.
...
- For any question regarding whereabouts, local assistance, etc., there is a team of students that is available to help, and should be contacted via email:
  - **TBA**
...
### Teaching philosophy
The lectures will be interactive, in a workshop-like style, using [Python](http://www.python.org), [scikit learn](https://scikit-learn.org/), [PyTorch](https://pytorch.org/), and [Hugging Face Transformers](https://huggingface.co/docs/transformers) on [Nuvolos](http://nuvolos.cloud),
